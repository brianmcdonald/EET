...
export const EVENT_TYPE_OPTIONS = [
  ...
  { value: EventType.DISPLACEMENT, label: 'Displacement' },
  { value: EventType.RETURN, label: 'Return' },
  { value: EventType.RELOCATION_RESETTLE, label: 'Relocation/Resettlement' },
];
...
export const INITIAL_EVENT_DATA = {
  ...
  eventEnd: '',
  eventType: '',
  movements: [{ id: crypto.randomUUID(), from: null, to: null, individuals: 0 }],
  trigger: '',
  priorityNeed1: '',
  priorityNeed2: '',
  priorityNeed3: '',
